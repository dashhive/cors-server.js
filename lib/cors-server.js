...
CorsProxy.create = function (opts) {
  ...
  console.log("Allowed Domains:", allowedHostnames.join(", "));
  ...
  async function handler(req, res) {
    console.log(req.method, req.url, req.headers.host || "[no host]");
    ...
    console.log("meta:", hostname, path);
